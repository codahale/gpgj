...
public class ElgamalKeyGenerator implements SubKeyGenerator {
     ...
     * RFC 3526, Section 2.
     */
    private static final ElGamalParameters ELGAMAL_1536 = new ElGamalParameters(
            new BigInteger(("FFFFFFFF FFFFFFFF C90FDAA2 2168C234 C4C6628B 80DC1CD1" +
    ...
    /**
     * Returns an {@link ElgamalKeyGenerator} which generates 1536-bit master keys.
     */
    public static ElgamalKeyGenerator elgamal1536() {
        return new ElgamalKeyGenerator(ELGAMAL_1536);
    }
