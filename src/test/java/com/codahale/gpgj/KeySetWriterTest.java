...
public class KeySetWriterTest extends BCTest {
    private final KeySetWriter writer = new KeySetWriter();
    ...
    @Test
    public void serializesItselfToBytes() throws Exception {
        final String encoded = new String(Base64.encode(writer.toByteArray(keySet)), StandardCharsets.US_ASCII);
